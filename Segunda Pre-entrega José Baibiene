...
CREATE VIEW `Ranking_Vta_Prod` AS
SELECT 
...
CREATE VIEW `Ranking_Comp_Prod` AS
SELECT 
...
INSERT INTO Usuarios_Salarios (Fecha_Modif, Nombre_Usuario, Salario_Ant, Salario_Nuevo, Operacion)
VALUES (NOW(), SESSION_USER(), OLD.Salario, NEW.Salario, 'Actualizacion de salario');
